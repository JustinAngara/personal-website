...
{
    id: 3,
    title: "Valorant Hacks & Anti-Cheat Bypass, Triggerbot, Aimbot, Recoil Crosshair",
    description: "Valorant cheat suite with advanced features like triggerbot, aimbot, and recoil crosshair. Implements anti-cheat bypass techniques to evade detection while providing real-time performance enhancements.",
    technologies: ["Java", "JavaCV", "Kernel Programming", "Classification Algorithms"],
    image: "🤖",
    liveUrl: '#',
    githubUrl: 'https://github.com/JustinAngara/multithreaded-valorant-algorithm',
    featured: true,
    category: "System Apps"
},
{
    id: 4,
    title: "Clash Royale Enemy Elixr",
    description: "A Clash Royale bot that predicts enemy elixir levels using a custom-trained AI model. Utilizes computer vision to analyze game state and provides real-time predictions for strategic advantage.",
    technologies: ["Java", "JavaCV", "Blue Stacks", "Classification Algorithms"],
    image: "🤖",
    liveUrl: '#',
    githubUrl: 'https://github.com/JustinAngara/Clash-Royale-Enemy-Elixir-Tracker',
    featured: true,
    category: "System Apps"
},
{
...
},
{
    ...
    image: "📡",
    liveUrl: "https://justinangara.github.io/xml-parser/",
    githubUrl: "#",
    featured: false,
    category: "AI/ML"
},
